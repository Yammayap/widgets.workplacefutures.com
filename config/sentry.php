...
return [
    ...
    'release' => file_exists(base_path('_RELEASE.txt')) ?
        trim(file_get_contents(base_path('_RELEASE.txt'))) : env('SENTRY_RELEASE'),
    ...
    'sample_rate' => env('SENTRY_SAMPLE_RATE') === null ?
        1.0 : (float)env('SENTRY_SAMPLE_RATE'),

    // @see: https://docs.sentry.io/platforms/php/guides/laravel/configuration/options/#traces-sample-rate
    'traces_sample_rate' => env('SENTRY_TRACES_SAMPLE_RATE') === null ?
        null : (float)env('SENTRY_TRACES_SAMPLE_RATE'),
